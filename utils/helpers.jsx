...
export const recipeLists = [
    {
      ...
      },
      {
        ...
        shortDescription : "Sisig (/ˈsiːsɪɡ/ Tagalog pronunciation: ['sisig]) is a Filipino dish made from pork jowl and ears (maskara), pork belly, and chicken liver, which is usually seasoned with calamansi, onions, and chili peppers.",
